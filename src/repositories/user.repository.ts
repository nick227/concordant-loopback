...
import {User, UserRelations, Organization, UserToOrganization, UserComment, UserMessage, Treaty} from '../models';
...
import {TreatyRepository} from './treaty.repository';
