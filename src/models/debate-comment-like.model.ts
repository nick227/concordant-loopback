...
@model({
  settings: {
    idInjection: false,
    mysql: {schema: 'concordant', table: 'debate_comment_like'}
  }
})
export class DebateCommentLike extends Entity {
  @property({
    type: 'number',
    generated: true,
    precision: 10,
  ...
  @property({
    ...
    precision: 10,
    scale: 0,
    mysql: {columnName: 'debate_comment_id', dataType: 'int', dataLength: null, dataPrecision: 10, dataScale: 0, nullable: 'N'},
  })
  ...
  constructor(data?: Partial<DebateCommentLike>) {
    super(data);
  }
}

export interface DebateCommentLikeRelations {
  // describe navigational properties here
}

export type DebateCommentLikeWithRelations = DebateCommentLike & DebateCommentLikeRelations;
