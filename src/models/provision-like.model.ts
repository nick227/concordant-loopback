...
@model({
  settings: {idInjection: false, mysql: {schema: 'concordant', table: 'provision_like'}}
})
export class ProvisionLike extends Entity {
  @property({
    type: 'number',
    generated: true,
    precision: 10,
  ...
  constructor(data?: Partial<ProvisionLike>) {
    super(data);
  }
}

export interface ProvisionLikeRelations {
  // describe navigational properties here
}

export type ProvisionLikeWithRelations = ProvisionLike & ProvisionLikeRelations;
