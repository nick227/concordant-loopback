...
@model({
  settings: {
    idInjection: false,
    mysql: {schema: 'concordant', table: 'treaty_comment_like'}
  }
})
export class TreatyCommentLike extends Entity {
  @property({
    type: 'number',
    generated: true,
    precision: 10,
  ...
  @property({
    ...
    precision: 10,
    scale: 0,
    mysql: {columnName: 'treaty_comment_id', dataType: 'int', dataLength: null, dataPrecision: 10, dataScale: 0, nullable: 'N'},
  })
  treaty_comment_id: number;
  ...
  constructor(data?: Partial<TreatyCommentLike>) {
    super(data);
  }
}

export interface TreatyCommentLikeRelations {
  // describe navigational properties here
}

export type TreatyCommentLikeWithRelations = TreatyCommentLike & TreatyCommentLikeRelations;
